          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                <li><Link href="/layanan-makanan" className="hover:text-white transition">Syarat Layanan Makanan</Link></li>
                <li><Link href="/requirements" className="hover:text-white transition">Syarat Perawat Lansia</Link></li>
